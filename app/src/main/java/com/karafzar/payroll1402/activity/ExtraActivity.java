...
public class ExtraActivity extends AppCompatActivity
{
    ...
    private EditText txtWages, txtExtra;
    private CheckBox chkWages;
    private TextView lblWagesDesc, lblResult;
    private int dayOfMonth, wages = 139325, currentWages, extra;
    ...
    private void InitializeComponent()
    {
        ...
        chkWages.setOnCheckedChangeListener((buttonView, isChecked) ->
        {
            ...
            if(isChecked)
            {
                ...
                txtWages.setText("");
                AnimationUtil.valueAnimator(lblResult, "میزان اضافه\u200cکاری: ", String.valueOf(extra));
            ...
            {
                txtExtra.setText("");
                AnimationUtil.valueAnimator(lblResult, "میزان اضافه\u200cکاری: ", "0");
        ...
        txtExtra.addTextChangedListener(new TextWatcher()
        {
            ...
            public void afterTextChanged(Editable editable)
            {
                ...
                if(editable.length() == 0 || editable.toString().equals("0"))
                    ...
                    AnimationUtil.valueAnimator(lblResult, "میزان اضافه\u200cکاری: ", String.valueOf((int)(currentWages * 1.4 / 220 * Double.parseDouble(editable.toString()))));
            }
        });
    }
